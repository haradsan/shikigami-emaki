...
const ART_PAL = {
  ...
  metal:   { bg1: "#5a4c14", bg2: "#1e1906", glow: "#ffe27c", sil: "#1a1404", line: "#e0bb45" },
...
function artDefsSVG() {
  ...
  const tileGrads = ["wood", "fire", "earth", "metal", "water"].map(k => {
    const p = ART_PAL[k];
...
const CREATURE_ART = {
  // ---- 木（芽吹きと再生） ----
  mebukiko:   { arch: "sprout" },
  yamahiko:   { arch: "fairy",    o: { bighead: 1, wings: false } },
  tsutaoni:   { arch: "vines" },
  hanamori:   { arch: "horse" },
  aotake:     { arch: "humanoid" },
  moriokami:  { arch: "beast" },
  ofuji:      { arch: "flower" },
  sennensugi: { arch: "tree",     o: { big: 1 } },
  kukunochi:  { arch: "tree",     o: { big: 1 } },
  kokezo:     { arch: "fairy",    o: { small: 1 } },
  kuzute:     { arch: "vines" },
  hanasaka:   { arch: "humanoid" },
  jukai:      { arch: "tree" },
  // ---- 火（勢いと燃え尽き） ----
  hinoko:     { arch: "fairy",    o: { spark: 1 } },
  taimatsu:   { arch: "beast",    o: { small: 1 } },
  kagerocho:  { arch: "insect",   o: { wings: 1 } },
  haikaburi:  { arch: "humanoid", o: { ribbon: 1 } },
  kagaribi:   { arch: "humanoid" },
  hikuidori:  { arch: "bird",     o: { flame: 1 } },
  higuma:     { arch: "beast",    o: { big: 1 } },
  homuraguruma: { arch: "humanoid", o: { ribbon: 1 } },
  yatagarasu: { arch: "bird",     o: { big: 1, flame: 1 } },
  hazeguri:   { arch: "fairy",    o: { spark: 1 } },
  hiya:       { arch: "humanoid", o: { small: 1 } },
  jinkai:     { arch: "humanoid" },
  shiranui:   { arch: "fairy",    o: { spark: 1 } },
  // ---- 土（不動と実り） ----
  tsuchidango: { arch: "golem",   o: { small: 1 } },
  haniwako:   { arch: "golem" },
  mogura:     { arch: "beast",    o: { small: 1 } },
  dorogame:   { arch: "turtle" },
  tanadagami: { arch: "rootman" },
  ishigaki:   { arch: "wall" },
  odoguu:     { arch: "golem",    o: { big: 1 } },
  jichingame: { arch: "turtle",   o: { big: 1 } },
  ubusuna:    { arch: "golem",    o: { big: 1 } },
  anamori:    { arch: "beast",    o: { small: 1 } },
  okame:      { arch: "golem",    o: { small: 1 } },
  ishizue:    { arch: "wall" },
  kanameishi: { arch: "wall",     o: { big: 1 } },
  // ---- 金（刃と富） ----
  zeniarai:   { arch: "beast",    o: { small: 1 } },
  sabimaru:   { arch: "humanoid", o: { small: 1 } },
  haribusuma: { arch: "beast",    o: { spikes: 1 } },
  togishi:    { arch: "beast" },
  kanekarasu: { arch: "bird" },
  kobyakko:   { arch: "beast" },
  tachidama:  { arch: "humanoid" },
  komyaku:    { arch: "golem" },
  kanayago:   { arch: "humanoid", o: { big: 1 } },
  zenigame:   { arch: "turtle" },
  tobikozuka: { arch: "humanoid", o: { small: 1 } },
  senryobako: { arch: "golem",    o: { small: 1 } },
  kajigami:   { arch: "humanoid", o: { big: 1 } },
  // ---- 水（流転と搦め手） ----
  amadare:    { arch: "fairy" },
  utakata:    { arch: "jelly" },
  kawagiri:   { arch: "humanoid", o: { ribbon: 1 } },
  takinobori: { arch: "serpent" },
  kaihime:    { arch: "mermaid" },
  yukijoro:   { arch: "humanoid", o: { ribbon: 1 } },
  onamazu:    { arch: "serpent",  o: { big: 1 } },
  ryugu:      { arch: "mermaid" },
  kuraokami:  { arch: "dragon" },
  amenbo:     { arch: "insect" },
  shiomaneki: { arch: "crab" },
  nigorinuma: { arch: "jelly",    o: { big: 1 } },
  umigiri:    { arch: "humanoid", o: { ribbon: 1 } },
  // ---- 無（付喪神と霊獣） ----
  suzuri:     { arch: "golem",    o: { small: 1 } },
  karakasa:   { arch: "humanoid", o: { small: 1 } },
  baku:       { arch: "beast",    o: { big: 1 } },
  kudagitsune: { arch: "beast",   o: { small: 1 } },
  gyoretsu:   { arch: "humanoid", o: { small: 1 } },
  shiramen:   { arch: "fairy" },
  // ---- 👑五帝（四神＋黄龍） ----
  seiryu:     { arch: "dragon",   o: { big: 1 } },
  suzaku:     { arch: "bird",     o: { big: 1, flame: 1 } },
  koryu:      { arch: "dragon",   o: { big: 1 } },
  byakko:     { arch: "beast",    o: { big: 1 } },
  genbu:      { arch: "turtle",   o: { big: 1 } },
};
...
const ITEM_ART = {
  takemitsu:  { arch: "sword" },
  yamagatana: { arch: "sword" },
  wazamono:   { arch: "sword", o: { big: 1, ornate: 1 } },
  ajirodate:  { arch: "shield" },
  kikkodate:  { arch: "shield", o: { tower: 1 } },
  kozuchi:    { arch: "charm" },
  hamayumi:   { arch: "bow" },
  hauchiwa:   { arch: "banner" },
  goshinkyo:  { arch: "mirror" },
  kiyome:     { arch: "orb" },
  jindaiko:   { arch: "banner" },
  kitsunemen: { arch: "charm" },
  gakinawa:   { arch: "lance" },
  juzu:       { arch: "charm" },
};
